...
const customerU = require('../controllers/clienteUsuarios')//funciones de llamada por parte del usuario
const customerA = require('../controllers/clienteAdministrador')//funciones de llamada por parte del administrador
const customerO = require('../controllers/clienteOpciones')//funciones de llamada por parte del administrador
...
//listar usuarios
routers.get('/admin/getUsuarios', customerA.getUsuarios)

//traer un usuario
routers.get('/admin/getOneUser/:id_user', customerA.getOneUser)
routers.get('/admin/getOneUser2/:id_user', customerA.getOneUser2)

//actualizar el rol de un usuario
routers.post('/updateUsuarios/',customerA.updateUsuarios)

//actualizar el estado de un usuario
routers.post('/updateUsuarios2/',customerA.updateUsuarios2)
